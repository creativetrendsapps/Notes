...
import static com.creativetrends.notes.DataUtils.BACKUP_FILE_NAME;
import static com.creativetrends.notes.DataUtils.BACKUP_FOLDER_PATH;
import static com.creativetrends.notes.DataUtils.NEW_NOTE_REQUEST;
import static com.creativetrends.notes.DataUtils.NOTES_FILE_NAME;
import static com.creativetrends.notes.DataUtils.NOTE_BODY;
import static com.creativetrends.notes.DataUtils.NOTE_COLOR;
import static com.creativetrends.notes.DataUtils.NOTE_FAVOURED;
import static com.creativetrends.notes.DataUtils.NOTE_FONT_SIZE;
import static com.creativetrends.notes.DataUtils.NOTE_HIDE_BODY;
import static com.creativetrends.notes.DataUtils.NOTE_REQUEST_CODE;
import static com.creativetrends.notes.DataUtils.NOTE_TITLE;
import static com.creativetrends.notes.DataUtils.deleteNotes;
import static com.creativetrends.notes.DataUtils.isExternalStorageReadable;
import static com.creativetrends.notes.DataUtils.isExternalStorageWritable;
import static com.creativetrends.notes.DataUtils.retrieveData;
import static com.creativetrends.notes.DataUtils.saveData;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (searchActive) {
            ...
            try {
                ...
                intent.putExtra(NOTE_COLOR, notes.getJSONObject(newPosition).getString(NOTE_COLOR));
        ...
        // If search is not active -> use normal position for EditActivity
            ...
            try {
                ...
                intent.putExtra(NOTE_COLOR, notes.getJSONObject(position).getString(NOTE_COLOR));
            ...
            if (mBundle != null) {
                ...
                if (requestCode == NEW_NOTE_REQUEST) {
                    ...
                    try {
                        ...
                        newNoteObject.put(NOTE_COLOR, mBundle.getString(NOTE_COLOR));
