...
public class DataUtils {
    ...
    public static final String NOTES_FILE_NAME = "notes.text"; // Local notes file name
    ...
    public static final String BACKUP_FILE_NAME = "notes_backup.text"; // Backup file name
